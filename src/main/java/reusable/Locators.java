...
public class Locators {
    ...
    public static final String DOWNLOAD_BUTTON = "(//*[contains(normalize-space(),'Download')])[1]";
    ...
    public static final String FC_Wait_For_File_List_Bottom_Bar = "FileListBottomBar";
